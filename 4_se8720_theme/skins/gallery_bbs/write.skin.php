...
<section id="bo_w">
    ...
    <div class="bo_w_info write_div">
	    ...
	    <?php } ?>
          ...
          <label for="wr_homepage" class="sound_only">좌,상,넓,높</label>
	        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input half_input" size="50" placeholder="">
	</div>
